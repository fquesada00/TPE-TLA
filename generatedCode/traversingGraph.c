...
char * name = "traversing";
GraphNode * n1 = newGraphNode(graph,name);
GraphNode * n2 = newGraphNode(graph,"with");
GraphNode * n3 = newGraphNode(graph,"procedure");
GraphNode * n4 = newGraphNode(graph,"fourth node");
GraphNode * n5 = newGraphNode(graph,"not last");
GraphNode * n6 = newGraphNode(graph,"last");

addEdge(n1,n2,(void*)"1",STRING_EDGE);
addEdge(n1,n3,(void*)(&(int){1}),INT_EDGE);
addEdge(n1,n6,(void*)"2",STRING_EDGE);
addEdge(n2,n4,(void*)(&(int){2}),INT_EDGE);
addEdge(n2,n3,(void*)"3",STRING_EDGE);
addEdge(n3,n4,(void*)(&(int){3}),INT_EDGE);
addEdge(n4,n6,(void*)"4",STRING_EDGE);
addEdge(n6,n4,(void*)(&(int){4}),INT_EDGE);
printf("Expected output for DFS traverse procedure:");
printf("\n0 -> 1 -> 3 -> 5 ->\n");
printf("\n0 -> 1 -> 2 -> 3 -> 5 ->\n");
printf("\n0 -> 2 -> 3 -> 5 ->\n");
printf("\n0 -> 5 -> 3 ->\n");
traverseDFS(graph,n1);
printf("Expected output for BFS traverse procedure:");
printf("\n0 -> 1 -> 2 -> 5 -> 3 ->\n");
traverseBFS(graph,n1);
removeNode(graph,n2);
removeEdge(n1,n3);
printf("Expected output for DFS traverse procedure:");
printf("\n0 -> 4 -> 2 ->\n");
...
nodeIterator = nextForEachNode(graph);
printf("Node with id: ");
printf("%d",nodeIterator->id);
printf(" and value: ");
printf("%s",nodeIterator->value);
beginForEachEdge(nodeIterator);
while(hasNextForEachEdge(nodeIterator)){
edgeIterator = nextForEachEdge(nodeIterator);
printf("edge weight: ");
printfEdge(edgeIterator);
}
printf("\n");
}
freeGraph(graph);
