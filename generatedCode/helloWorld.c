...
GraphNode * n1 = newGraphNode(graph,"h");
GraphNode * n2 = newGraphNode(graph,"l");
GraphNode * n3 = newGraphNode(graph,"o");
GraphNode * n4 = newGraphNode(graph,"w");
GraphNode * n5 = newGraphNode(graph,"r");
GraphNode * n6 = newGraphNode(graph,"d");

addEdge(n1,n2,(void*)"e",STRING_EDGE);
addEdge(n2,n3,(void*)"l",STRING_EDGE);
addEdge(n3,n4,(void*)" ",STRING_EDGE);
addEdge(n4,n5,(void*)"o",STRING_EDGE);
addEdge(n5,n6,(void*)"l",STRING_EDGE);
addEdge(n6,n1,(void*)"!",STRING_EDGE);
