...
printf("aca si quiero entrar\n");
}
a = 0;
if(a){
printf("aca tampoco quiero entrar\n");
}else if(!a){
printf("anda el !\n");
}
a = 1;
if(a && b){
printf("no anda el and\n");
}else if(b || a){
printf("si anda el or\n");
}
a = 7;
if(a > 10){
printf("no anda el mayor\n");
}else if(a > 8){
printf("no anda el mayor");
}else if(a < 8){
printf("andan el menor y el else-if\n");
}
freeGraph(graph);
}